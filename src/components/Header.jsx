...
const Header = () => {
    ...
    return (
        <header className="flex bg-primary justify-between py-8 px-8 shadow-lg">
            <h2 className="font-Nunito text-text-color font-extrabold text-3xl">Where in the World?</h2>
            <button onClick={switchTheme} className="flex space-x-2">
                ...
                <h5 className="font-Nunito text-text-color font-semibold">Dark mode</h5>
            </button>
        </header>
    );
}
